...
function Timer(Props) {
	var match = React.useReducer(
		function(state, action) {
			switch (action) {
				case 0:
					return /* record */ [ /* seconds */ state[/* seconds */ 0], /* isTicking */ true ];
				case 1:
					return /* record */ [ /* seconds */ state[/* seconds */ 0], /* isTicking */ false ];
				case 2:
					return /* record */ [ /* seconds */ 30, /* isTicking */ state[/* isTicking */ 1] ];
				case 3:
